...
Copy these files into the active `versions/MAJOR.MINOR/` dossier and replace instructional comments. Keep stable IDs after assignment.

- `spec.md`: externally observable product behavior
